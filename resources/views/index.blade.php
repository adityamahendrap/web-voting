                                ...
                                <div class="feature-box-info pl-1">
                                    ...
                                    <p class="mb-0">
                                        ...
                                        <span class="social-icons-twitter pl-1"><a href="https://line.me/ti/p/~deyaachan"
                                                ...
                                                title="Line"><i class="mr-1 fab fa-line"></i> deyaachan</a></span>
                                    </p>
                                                    ...
                                                    <div> <span class="vertical-timeline-element-icon bounce-in"> <i
                                                        ...
                                                        <div class="vertical-timeline-element-content bounce-in">
                                                            ...
                                                            <p class="text-justify">
                                                                ...
                                                                tanggal <strong>{{ $data['masa_registrasi']['description'] }}. </strong>
                                                            </p>
                                                    ...
                                                    <div> <span class="vertical-timeline-element-icon bounce-in"> <i
                                                        ...
                                                        <div class="vertical-timeline-element-content bounce-in">
                                                            ...
                                                            <p class="text-justify">Ketika akun sudah terverifikasi, maka akun
                                                                ...
                                                                memilih secara serempak pada tanggal <b>{{ $data['masa_pemilihan']['description'] }}</b>.</p>
